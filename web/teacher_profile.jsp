...
<html>
 ...
 <div class="row">   
  ...
  <div class="row" style="margin-left:30%;margin-right:30%">
       <div class="col-sm-6">
         ...
         <button type="submit" class="btn btn-default" >Upload</button>
           ...
           <!-- SCAN-->
           <div>
              <button onclick="setTimeout(control(), 3000);" style="margin-top:10px">Scan</button>
  ...
  <form class="form-horizontal" action="profile" method="POST" style="padding-top:2%">
    
   <div class="form-group">
      <label class="control-label col-sm-2" for="email">DOCTOR QUALIFICATION</label>
      <div class="col-sm-10">
          <input type="text" class="form-control"  placeholder="Qualification" name="eu" required>
      </div>
    </div>   
      
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Clinic/Hospital Address</label>
      <div class="col-sm-10">
          <input type="text" class="form-control"  placeholder="Institue" name="teach" required>
      </div>
    </div>    
     
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">About</label>
      <div class="col-sm-10">
          <textarea class="form-control" rows="5" name="about" placeholder="max charecter 300"></textarea>          
      </div>
    </div>  
